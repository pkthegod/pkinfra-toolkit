...
curl -fsSL .../bootstrap.sh | sudo bash -s -- --version 2026.08.14.1 --sha256 <hash>
...
>
> ```bash
> curl -fsSL https://raw.githubusercontent.com/pkthegod/pkinfra-toolkit/v2026.08.14.1/bootstrap.sh \
>   | sudo bash -s -- --version 2026.08.14.1 --sha256 <hash>
> ```
>
...
```bash
git checkout v2026.08.14.1 && ./build.sh
# compare dist/pkinfra-toolkit-2026.08.14.1.tar.sha256 com o publicado no release
```
